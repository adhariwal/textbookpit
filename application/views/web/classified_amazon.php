<div class="col-lg-10 content-right">
          <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url();?>index.php/classified_ads/index">Classified Ads</a></li>
               <li><a href="<?php echo base_url();?>index.php/classified_ads/index">Amazon Product</a></li>
          </ol>
...
document.getElementById('main_data_p1').innerHTML='<img src="<?php echo base_url();?>images/1445974136-loading.gif" />'
	...
	if (getSecretAccessKey() == "AWS Secret Access Key") {
	  ...
	  return;
        ...
        var unsignedUrl = 'http://webservices.amazon.com/onca/xml?Service=AWSECommerceService&Version=2009-03-31&Operation=ItemLookup&ItemId=<?php echo $_GET['asin']; ?>&ResponseGroup=Images,ItemAttributes,Offers,Reviews,Large&AssociateTag=textbookpit-20';
        if (unsignedUrl == "") {
	...
	if (matches == null) {
	  ...
	  // alert(signedUrl);
	   ...
	   $.ajax({
		url: '<?php echo base_url();?>index.php/classified_ads/details_amazon',
		type: 'get',
		dataType: 'html',
    ...
    <form id="filter_form1">               
             <textarea name="main_url1" id="main_url1" style="display:none;" ></textarea>   
   </form>
          <div class="row classifieds-table" id="main_data_p1">
           
          
          </div>
        </div><script> get_data();</script>
