...
<div id="content" class="span10">
    <ul class="breadcrumb">
        ...
        <li>
            ...
            <a href="<?php echo base_url();?>index.php/paidads">Baner Ads</a>
        </li>
    </ul>
    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><i class="halflings-icon edit"></i><span class="break"></span>New Paid Ad</h2>
            </div>
            <div class="box-content">
                    ...
                    <?php echo form_open_multipart(base_url().'index.php/paidads/addPaidads', array('class'=>'form-horizontal'));?>
                    <fieldset>
                      ...
                      <div class="control-group">
                        <label class="control-label" for="focusedInput">Paid Ad Image*</label>
                        <div class="controls">
