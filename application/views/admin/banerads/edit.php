    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><i class="halflings-icon edit"></i><span class="break"></span>Edit Baner</h2>
            </div>
            <div class="box-content">
                ...
                <?php echo form_open_multipart(base_url().'index.php/banerads/editBanerads/'.$id, array('class' => 'form-horizontal')) ?>
                <fieldset>
                    <input type="hidden" name="baner_id" id="baner_id" value="<?php echo $id?>">
                    ...
                    <div class="control-group">
                        <label class="control-label" for="focusedInput">Baner Ad Status</label>
                        <div class="controls">
                            <select id="selectBaner" name="selectBaner" data-rel="chosen1">
                                <?php if ($status == 1) {?>
